...
<body>
    ...
    <p>
        <a href="http://localhost:5173/login/{{ $data['uid'] }}/{{ $data['token'] }}" 
    ...
    <p><strong>AgriFlow</strong> - <span style="font-style: italic; font-size: 12px;">(Não responda à esse e-mail)</span></p>
</body>
</html>
