...
var Z = (t, e, n) => e in t ? W(t, e, { enumerable: true, configurable: true, writable: true, value: n }) : t[e] = n;
...
var $ = ["+", "-"];
var V = ["decimal", "thousands", "prefix", "suffix"];
function d(t) {
...
function b(t, e) {
  return $.includes(t) ? (console.warn(`v-money3 "${e}" property don't accept "${t}" as a value.`), false) : /\d/g.test(t) ? (console.warn(`v-money3 "${e}" property don't accept "${t}" (any number) as a value.`), false) : true;
}
function le(t) {
  for (const e of V)
    if (!b(t[e], e))
...
function j(t) {
  return new Event(t, { bubbles: true, cancelable: false });
}
function r({ debug: t = false }, ...e) {
  t && console.log(...e);
}
var p = class {
  constructor(e) {
  ...
  toString() {
    ...
    if (this.decimal) {
      let n = false;
      return e.charAt(0) === "-" && (e = e.substring(1), n = true), e = e.padStart(e.length + this.decimal, "0"), e = `${e.slice(0, -this.decimal)}.${e.slice(-this.decimal)}`, e = C(e), (n ? "-" : "") + e;
    }
    return e;
  }
  lessThan(e) {
...
var de = defineComponent({
  ...
  setup(t, { emit: e }) {
    const n = t, { modelValue: i, modelModifiers: a, masked: s, precision: u, shouldRound: o, focusOnRight: g } = toRefs(n);
    ...
    const h = ref(k(f, n, "component setup"));
    r(n, "component setup() - data.formattedValue", h.value), watch(i, y);
    function y(m) {
    ...
    return (m, c) => {
      const K = resolveDirective("money3");
      return withDirectives((openBlock(), createElementBlock("input", mergeProps({
        ...
        [K, {
          ...
          debug: n.debug,
          modelModifiers: unref(a),
          shouldRound: unref(o),
          focusOnRight: unref(g)
        }]
      ]);
    };
  }
...
//# sourceMappingURL=v-money3.js.map
